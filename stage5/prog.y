...
ELSE WHILE DO ENDWHILE LT GT NOT VAR NUP LID LSB RSB STRING MAIN LCB RCB PM
%right EQUAL
%left PLUS MINUS
%left MUL DIV
...
FdefBlock : FdefBlock Fdef {printf(" y14 ");}
      | Fdef {printf(" y15 ");}
      ;
MainBlock : Type MAIN LP RP LCB LdeclBlock Body RCB {printf(" y16 ");int l=getlabel();fprintf(outputfile,"L%d:\n",l);generate($7);l=getlabel();fprintf(outputfile,"L%d:\n",l);}
      ;
Fdef : Type ID LP ParamList RP LCB LdeclBlock Body RCB {printf(" y17 ");int l=getlabel();fprintf(outputfile,"L%d:\n",l);$2->binding=l;generate($8);l=getlabel();fprintf(outputfile,"L%d:\n",l);resetreg();}
      ;
...
Type : INT {printf(" y21 ");$$=1;}
      | STR {printf(" y22 ");$$=2;}
      ;
LdeclBlock : DECL LDecList ENDDECL {printf(" y23 ");$$=$2;}
...
ArgList : ArgList COMMA expr {printf(" y30 ");$1->Arglist=$3;$$=$1;}
      | expr {printf(" y31 ");$$=$1;}
      ;
Body : BEGN Slist END SEMCL {printf(" y32 ");$$=$2;}
      | BEGN END SEMCL  {printf(" y33 ");$$=NULL;}
      ;
