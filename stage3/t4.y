...
%type <tn> expr program NUM END AsgStmt OutputStmt InputStmt Stmt Slist ID E IfStmt WhileStmt BreakStmt ContinueStmt
%token NUM PLUS END MINUS DIV MUL ID BEGN READ WRITE EQUAL SEMCL LP RP IF THEN ENDIF BREAK CONTINUE
